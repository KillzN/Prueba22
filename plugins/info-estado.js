...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  ${tradutor.texto1[2]} +56987654321
  ${tradutor.texto1[3]} https://chat.whatsapp.com/awdawdw
  ...
  const Message = {
    document: { url: `https://www.instagram.com/Pedrito.J/` },
    ...
    contextInfo: {
      ...
      isForwarded: true,
      externalAdReply: {
        mediaUrl: "https://www.instagram.com/Pedrito.J/",
        mediaType: 2,
        previewType: "pdf",
        title: "KillzN",
        body: tradutor.texto2,
        thumbnail: imagen1,
        sourceUrl: "https://www.instagram.com/Pedrito.J/",
      },
    },
    caption: info,
    footer: wm,
